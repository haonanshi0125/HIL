...
class regdb_rgb(BaseImageDataset):
    """
    Market1501
    Reference:
    ...
    def __init__(self, root,trial=0, verbose=True, **kwargs):
        ...
        self.query_dir = osp.join(self.dataset_dir, str(trial)+'/'+'query')#osp.join(self.dataset_dir, 'query')
